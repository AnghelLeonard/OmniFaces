...
public class PhoneNumberConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (!value.matches("^[0-9]{10}")) {
            throw new ConverterException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                    "Phone number must have 10 digits !", null));
        }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        LOG.log(Level.INFO, "getAsString called for: {0} with value: {1}", new Object[]{component.toString(), value});
        PhoneNumber phoneNumber = (value != null) ? ((PhoneNumber) value) : null;
        return (phoneNumber != null)
                ? String.valueOf(phoneNumber.getAreacode())
                .concat(String.valueOf(phoneNumber.getExchange())
                        .concat(String.valueOf(phoneNumber.getSubscriber())))
                : "";
    }
}
